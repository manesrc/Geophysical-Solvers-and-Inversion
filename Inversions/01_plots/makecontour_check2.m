function makecontour_check2(var,pointsXY,plot_num,ne_x,ne_y,LABData,Contours,title_fig)
% receives a vectorial variable and a set of ponts and plots a contour plot
% INPUTS :
%               pointsXY: Points where the information "var" is 
%               var: the variable to plot
%               plot_num: the number of the window 
%               InfoMesh: t
x_points = pointsXY(:,1);
y_points = pointsXY(:,2);
