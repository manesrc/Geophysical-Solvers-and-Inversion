...
% max Depth
maxDepth = InfoProblem.L_ref * max(X(:,2));
% TLAB
...
for ielem = 1:nOfElements
   ...
   if ismember(ielem,listOmega1)
       ...
       [Ke,Ge,fe,muee,tempee,rhoee,Xee] = makeElementMatrix(Xe, ...
          ...
          nOfPressureNodesPerElement,NP,material,temperature_el,LS_el,tolerance, maxDepth, T_LAB);
   ...
   elseif ismember(ielem,listInt)
       ...
       [Ke,Ge,fe,muee,tempee,rhoee,Xee] = makeElementMatrix(Xe, ...
          ...
          nOfPressureNodesPerElement,NP1,material,temperature_el,LS_el,tolerance, maxDepth, T_LAB);
   else
       error('cosas raras')
   end
