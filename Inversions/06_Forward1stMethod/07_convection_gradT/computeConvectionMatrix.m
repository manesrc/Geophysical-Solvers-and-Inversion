function G_convMat = computeConvectionMatrix(velo, temp_est, pres_est,MeshIntegration,InfoMesh,InfoProblem,InfoMaterial)
...
for ielem1 = 1:nelem
    ...
    temp_elem = temp_est(Te);
    pres_elem = pres_est(Te);
    ...
    Ge = mgElementMatrix(temp_elem, pres_elem, LS_element, Xe,velo_element,interface,nnode_el, pespg, N, Nxi, Neta, InfoProblem,InfoMesh,InfoMaterial);
    % indices
